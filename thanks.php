...
<div class="cards">
	...
	<input type = "hidden" name = "image" value = "10">
	<div class="title">
		<h1>Thank You.</h1>
	...
	<div class="description">
		<textarea class="form-control col-xs-12" name="message" placeholder="Enter Your message..!"></textarea>
		<p>Thank You for help me in the study.</p>
		<input type = "hidden" name = "footer" value = "Thank you for help me in the study.">
...
<div class="cards">
	...
	<div class="description">
		<textarea class="form-control col-xs-12" name="message" placeholder="Enter Your message..!"></textarea>
		<p>Without your spport my project is incomplete.</p>
		<input type = "hidden" name = "footer" value = "Without your spport my project is incomplete.	">
	<input type="submit" name="Preview" value="Preview" class="btn btn-primary">
	</div>
	</form>	
</div>
